...
<head>
    ...
    <title>Page Not Found - {{ \App\HelperClass::generalSettings()->business_name ?? 'Smart Ecom' }}</title>
...
<body>
    <div class="not-found-card">
        ...
        <div class="code-hint">Error Code: 404</div>
    </div>
</body>
</html>
@endif
