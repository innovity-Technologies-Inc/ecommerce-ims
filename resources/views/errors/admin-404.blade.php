...
<head>
    ...
    <title>Admin - Page Not Found | {{ \App\HelperClass::generalSettings()->business_name ?? 'Smart Ecom' }}</title>
...
<body>
    ...
    <div class="container">
        <div class="icon-box">
            <iconify-icon icon="solar:map-point-remove-bold-duotone" style="font-size: 50px; color: #fff;"></iconify-icon>
        </div>
        <div class="error-code">404</div>
        <h1>Route Not Found</h1>
        <p>The administrative page you are looking for does not exist or has been moved. <br><strong>Please return to the dashboard.</strong></p>
        
        <a href="{{ url('/admin/dashboard') }}" class="btn-action">
            <iconify-icon icon="solar:widget-2-bold-duotone" style="font-size: 20px;"></iconify-icon>
            Back to Dashboard
        </a>
    </div>
</body>
