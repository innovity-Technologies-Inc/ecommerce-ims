...
@if($contact->whatsapp_status && $contact->whatsapp_url)
    ...
    <style>
        .whatsapp-widget {
            position: fixed;
            bottom: 30px;
            right: 90px; /* Offset to the left of ScrollUp button on desktop */
            z-index: 999999;
        ...
        .whatsapp-chat-window {
            position: absolute;
            bottom: 70px;
            right: -60px; /* Adjust to fit screen when button is offset */
            width: 320px;
            background: white;
            border-radius: 12px;
        ...
        @media (max-width: 576px) {
            .whatsapp-widget {
                bottom: 85px; /* Stacked above the ScrollUp button */
                right: 20px;
            }
            .whatsapp-chat-window {
                width: 280px;
        ...
        $(document).ready(function() {
            ...
            $sendBtn.on('click', function() {
                ...
                if (message) {
                    ...
                    // 2. Intelligent correction for common mistakes
