...
<div class="auth-page-wrapper">
    <div class="auth-card">
        <div class="auth-side-banner">
            ...
            <p class="fs-16 opacity-75">No worries! Just enter your email address and we'll send you a link to reset your password.</p>
            <div class="mt-auto">
        ...
        <div class="auth-form-content">
            <div class="auth-header mb-4">
                <h3>Reset Request</h3>
                <p class="text-muted">We will email you a secure reset link.</p>
            </div>
