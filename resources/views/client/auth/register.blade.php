                                            ...
                                            @if(config('services.google.client_id'))
                                                <div class="login-social mt-4 text-center">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <a href="{{ route('auth.google') }}" class="btn p-0 border-0 d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; transition: transform 0.2s; background: none;" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" title="Register with Google">
