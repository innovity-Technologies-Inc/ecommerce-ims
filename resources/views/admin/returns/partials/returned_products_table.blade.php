                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-3">
                            <img src="{{ $item->product->primaryImage ? \App\HelperClass::file_url($item->product->primaryImage->image_path) : asset('admin_assets/images/no-image.png') }}" class="rounded-pill" style="width: 35px; height: 35px; object-fit: cover;">
                            <div>
