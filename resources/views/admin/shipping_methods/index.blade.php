    ...
    <div class="container-xxl">
        ...
        <div class="card overflow-hidden">
                ...
                <div class="row align-items-center g-2">
                    <div class="col-lg-4">
                        <div class="search-box">
                            <input type="text" class="form-control" id="search-input" placeholder="Search methods..." value="{{ request('search') }}">
                        </div>
                    </div>
                    <div class="col-lg-2">
            ...
            <div class="card-body p-0" id="table-container">
                @include('admin.shipping_methods.partials.table')
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#search-input').on('keyup', function() {
            ...
            searchTimer = setTimeout(fetchMethods, 500);
        });

        $('#status-select, #sort-select').on('change', fetchMethods);
        ...
        $(document).on('change', '.status-toggle', function() {
            ...
            const url = `{{ route('admin.shipping_methods.toggle-status', ':id') }}`.replace(':id', id);
