                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <p class="extra-small text-muted mt-1">This will be the main display image. Recommended size: 800x800 px (1:1 Ratio). Allowed: jpeg, png, webp, avif. Max 2MB.</p>
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            ...
                                            <p class="extra-small text-muted mt-1">Select up to 5 additional images. Recommended size: 800x800 px (1:1 Ratio). Allowed: jpeg, png, webp, avif. Individual size must not exceed 2MB.</p>
