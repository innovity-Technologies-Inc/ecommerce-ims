                                ...
                                <table class="table table-bordered align-middle" id="itemsTable">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input type="text" id="displayTotal" class="form-control" readonly value="0.00">
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '.product-select', function() {
            ...
            if (selected.startsWith('v-')) {
                row.find('.product-id').val(''); // Backend will handle finding product id from variant if needed, or we can improve this
                row.find('.variant-id').val(selected.replace('v-', ''));
                // Need to find product_id for variant
                @foreach($products as $product)
                    @foreach($product->variants as $variant)
