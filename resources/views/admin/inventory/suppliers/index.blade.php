    ...
    <div class="container-xxl">
        ...
        <div class="card overflow-hidden">
                ...
                <div class="row align-items-center g-2">
                    <div class="col-lg-4">
                        <div class="search-box">
                            <input type="text" class="form-control" id="search-input" placeholder="Search suppliers..." value="{{ request('search') }}">
                        </div>
                    </div>
            ...
            <div class="card-body p-0" id="table-container">
                @include('admin.inventory.suppliers.partials.table')
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#search-input').on('keyup', function() {
            ...
            searchTimer = setTimeout(fetchSuppliers, 500);
        });

        $('#sort-select').on('change', fetchSuppliers);
