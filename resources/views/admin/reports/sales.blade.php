                    ...
                    <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-sm btn-soft-secondary" onclick="printFullReport('trends')">
                                    <i class="bx bx-printer"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-sm btn-soft-secondary" onclick="printFullReport('payment_method')">
                                    <i class="bx bx-printer"></i>
                                </button>
                            </div>
                        </div>
