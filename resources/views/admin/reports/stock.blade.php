...
<script>
    ...
    $(document).ready(function() {
        if (new URLSearchParams(window.location.search).has('is_print')) {
            ...
            $('<style>')
                ...
                .html(`
                    @media print {
                        ...
                        .badge { border: 1px solid #000; padding: 2px 5px; border-radius: 3px; font-size: 10px; color: black !important; background: transparent !important; }
                    }
                `)
                .appendTo('head');
            ...
            // Close the tab after printing (optional, but clean)
            setTimeout(() => {
